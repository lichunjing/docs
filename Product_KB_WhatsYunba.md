...
云巴基于 [MQTT](http://public.dhe.ibm.com/software/dw/webservices/ws-mqtt/mqtt-v3r1.html)，支持 [Socket.IO](SocketIO_API_APIManual.md) 协议，支持 [RESTful API](RESTful_API_APIManual.md)。
...
云巴支持 [频道](Product_KB_TopicAndAlias.md)（Topic）和 [别名](Product_KB_TopicAndAlias.md)（Alias）两种发布消息的方式：
